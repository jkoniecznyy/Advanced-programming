...
class Library:
    ...
    def __str__(self) -> str:
        return f'Ksiegarnia: {self.street} {self.zip_code} ' \
               f'{self.city}, godziny {self.open_hours}, nr {self.phone}'
...
class Book:
    ...
    def __str__(self) -> str:
        return f'Ksiazka: {self.publication_date}, {self.author_name} ' \
               f'{self.author_surname}, {self.number_of_pages} ' \
               f'stron, z {self.library}'
